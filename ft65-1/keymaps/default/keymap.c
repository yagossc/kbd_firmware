...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
                     ...
                     KC_N, KC_SPACE, KC_RALT, KC_RGUI, KC_HOME, KC_PGDOWN, KC_END,
                     KC_QUOTE, KC_1, KC_2, KC_3, KC_4, KC_5,
                     KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_6,
                     MO(_FN), KC_A, KC_S, KC_D, KC_F, KC_T,
    ...
    [_FN] = LAYOUT(
                     ...
                     KC_MS_WH_DOWN, KC_MS_BTN1, KC_MS_BTN2, KC_NO, KC_LEFT, KC_DOWN, KC_RIGHT,
